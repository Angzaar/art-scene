...
export function initDominos(){
    ...
    Transform.create(entity, {position: Vector3.create(77, 0, -4.75), rotation:Quaternion.fromEulerDegrees(0,-90,0)})
    GltfContainer.create(entity, {src:"assets/dominos.glb"})

    let avatar = engine.addEntity()
	Transform.create(avatar, {position: Vector3.create(74,.1,-5.9), rotation:Quaternion.fromEulerDegrees(0,180,0)})
