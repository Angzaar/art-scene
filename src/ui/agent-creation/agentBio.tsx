...
export function AgentBioPage() {
    return (
        <UiEntity
            key={resources.slug + "eliza::bio-ui"}
            uiTransform={{
                display: view === "Bio" ? 'flex' : 'none',
...
uiText={{value:"A.I. Bio", fontSize:sizeFont(35,25)}}
/>
...
uiText={{value:"Character background as a string or list of statements. Contains biographical information about the character. Multiple statements are randomized to create variety in responses", fontSize:sizeFont(30,20)}}
/>
...
<Input
    ...
    onChange={(e)=>{
        ...
        color={Color4.White()}
        placeholder={"Enter new bio statement"}
