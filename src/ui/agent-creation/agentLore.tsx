...
export function updateLorePage(){
    ...
    visibleItems = paginateArray([...newAgent.lore], visibleIndex, 10)
}

export function AgentLorePage() {
    return (
        <UiEntity
            key={resources.slug + "eliza::lore-ui"}
            uiTransform={{
                display: view === "Lore" ? 'flex' : 'none',
...
uiText={{value:"A.I. Lore", fontSize:sizeFont(35,25)}}
/>
...
uiText={{value:"Backstory elements and unique character traits. These help define personality and can be randomly sampled in conversations.", fontSize:sizeFont(30,20)}}
/>
...
<Input
    ...
    onChange={(e)=>{
        ...
        color={Color4.White()}
        placeholder={"Enter new lore statement"}
