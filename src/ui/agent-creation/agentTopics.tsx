...
export function AgentTopicsPage() {
    return (
        <UiEntity
            key={resources.slug + "eliza::topics-ui"}
            uiTransform={{
                display: view === "Topics" ? 'flex' : 'none',
...
uiText={{value:"A.I. Topics", fontSize:sizeFont(35,25)}}
/>
...
uiText={{value:"List of subjects the character is interested in or knowledgeable about. Used to guide conversations and generate relevant content. Helps maintain character consistency", fontSize:sizeFont(30,20)}}
/>
...
<Input
    ...
    onChange={(e)=>{
        ...
        onSubmit={(e) =>{ 
            ...
            updateNewAgent({topics: bio}, true)
            bio = ""
        }}
...
function generateRows(){
    let arr:any[] = []
    newAgent.topics.forEach((item:any, i:number)=>{
       arr.push(
                  <UiEntity
                  uiTransform={{
                      flexDirection: 'row',
